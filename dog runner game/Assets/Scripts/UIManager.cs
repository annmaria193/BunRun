...
public class UIManager : MonoBehaviour
{
    ...
    {
        fadeFromBlack = false; // Make sure fade from black is off
        FadeScreen(1f);
    ...
    {
        fadeToBlack = false; // Make sure fade to black is off
        FadeScreen(0f);
    ...
    public void ResetFade()
    {
        fadeToBlack = false;
        fadeFromBlack = false;
        blackScreen.color = new Color(0, 0, 0, 0); // Ensure transparency
    }
